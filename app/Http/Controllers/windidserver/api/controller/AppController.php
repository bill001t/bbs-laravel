...
class AppController extends OpenBaseController{
	...
	public function addAction(Request $request) {
		list($name, $siteip, $siteurl, $secretkey, $charset, $apifile, $issyn, $isnotify) = $request->get(array('name', 'siteip', 'siteurl', 'secretkey', 'charset', 'apifile', 'issyn', 'isnotify'));
	...
	public function editApp() {
		list($id, $name, $siteip, $siteurl, $secretkey, $charset, $apifile, $issyn, $isnotify) = $request->get(array('id', 'name', 'siteip', 'siteurl', 'secretkey', 'charset', 'apifile', 'issyn', 'isnotify'));
