...
class AppsController extends Controller{
	...
	public function beforeAction($handlerAdapter) {
		...
		if (!$this->loginUser->isExists()) {
			return redirect('u/login/run', array('backurl' => url('appcenter/app/run', array('appid' => $this->appid))));
		}
	}
	...
	public function run() {
		...
		if (!$status) return $this->showError(array('APPCENTER:get.app.url.fail', array('{{error}}' => $result)));
