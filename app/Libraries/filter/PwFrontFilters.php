...
class PwFrontFilters extends AbstractWindBootstrap {
	...
	public function onCreate() {
		Core::createapp(Wind::getAppName());
		
		$_debug = Core::C('site', 'debug');
		...
		if ($components = Core::C('components')) {
	...
	public function onStart() {
		Core::app()->beforeStart($this->front);
	}
	...
	public function onResponse() {
		Core::app()->beforeResponse($this->front);
	}
