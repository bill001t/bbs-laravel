...
class PwHook {
	...
	public static function initRegistry() {
		$data = app('hook.srv.PwHookInjectService')->fetchInjectByHookName(self::$prekeys);
	...
	public static function getRegistry($registerKey) {
		...
		if (!isset(self::$hooks[$registerKey])) {
			self::$hooks[$registerKey] = app('hook.srv.PwHookInjectService')->getInjectByHookName($registerKey);
		}
