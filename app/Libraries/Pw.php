...
class Pw {
	...
	public static function strlen($string) {
		return WindString::strlen($string, Core::V('charset'));
	}
	...
	public static function substrs($string, $length, $start = 0, $dot = true) {
		...
		return WindString::substr($string, $start, $length, Core::V('charset'), $dot);
	}
	...
	public static function jsonEncode($value) {
		return WindJson::encode($value, Core::V('charset'));
	}
	...
	public static function jsonDecode($value) {
		return WindJson::decode($value, true, Core::V('charset'));
	}
