...
namespace App\Services\link\bs;

use App\Services\link\dm\PwLinkDm;
use App\Services\link\ds\dao\PwLinkDao;
use App\Services\link\ds\dao\PwLinkRelationsDao;
use App\Services\link\ds\dao\PwLinkSearchDao;
use App\Services\link\ds\dao\PwLinkTypeDao;
use App\Services\link\vo\PwLinkSo;
...
class PwLink
{
    ...
    public function updateLinkType($typeId, $name, $vieworder)
    {
        ...
        return $this->_getLinkTypeDao()->_update($typeId, $data);
    }
    ...
    {
        return app(PwLinkTypeDao::class);
    }
    ...
    {
        return app(PwLinkRelationsDao::class);
    }
    ...
    {
        return app(PwLinkSearchDao::class);
    }
}
