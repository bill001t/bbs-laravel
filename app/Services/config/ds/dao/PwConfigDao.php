...
namespace App\Services\config\ds\dao;

use App\Services\config\ds\relation\config;
use App\Services\config\ds\traits\configTrait;
use App\Core\Hook\SimpleHook;

/**
 * 配置信息数据访问层
 */
class PwConfigDao extends config
{
	use configTrait;
