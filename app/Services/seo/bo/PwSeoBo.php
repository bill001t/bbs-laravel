...
class PwSeoBo
{
    ...
    {
        $sitename = Core::C('site', 'info.name');
    ...
    {
        $this->default || $this->default = app(\App\Http\Controllers\seo\service\PwSeoExtends::class)->getDefaultSeoByPage(
            $page, $mod);
        /*
