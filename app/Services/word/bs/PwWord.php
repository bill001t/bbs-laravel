...
namespace App\Services\word\bs;

use App\Services\word\dm\PwWordDm;
use App\Services\word\ds\dao\PwWordDao;
use App\Services\word\vo\PwWordSo;
...
class PwWord
{
    ...
    public function _delete($wordId)
    {
        ...
        $result = $this->_getDao()->_delete($wordId);
        return $result;
    }
    ...
    public function update(PwWordDm $dm)
    {
        ...
        $result = $this->_getDao()->_update($dm->id, $fieldData);
        return $result;
    }
