...
namespace App\Services\announce\bs;

use App\Services\announce\dm\PwAnnounceDm;
use App\Services\announce\ds\dao\PwAnnounceDao;
...
class PwAnnounce
{
    ...
    {
        return app(PwAnnounceDao::class);
    }
}