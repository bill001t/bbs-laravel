...
namespace App\Services\announce\dm;
 ...
 * @package wind
 */
class PwAnnounceDm extends BaseDm
{
    public $aid = 0;
    public $_data = array();
    ...
    {
        $time = $startDate ? Tool::str2time($startDate) : Tool::str2time(Tool::time2str(Tool::getTime(), 'Y-m-d'));
    ...
    {
        $time = $endDate ? Tool::str2time($endDate) : 9999999999;
    ...
    public function _beforeAdd()
    {
        ...
        if (!isset($this->_data['typeid'])) {
            return new ErrorBag('ANNOUNCE:typeid,require');
        }
