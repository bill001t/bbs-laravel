...
namespace App\Services\draft\bs;

use App\Services\draft\dm\PwDraftDm;
use App\Services\draft\ds\dao\PwDraftDao;
...
class PwDraft
{
    ...
    public function updateDraft($id, PwDraftDm $dm)
    {
        ...
        return $this->_getDraftDao()->_update($id, $dm->getData());
    }
