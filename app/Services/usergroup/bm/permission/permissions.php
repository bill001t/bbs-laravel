...
return array(
	...
	'invite_allow_buy'		=> array('radio', 'basic', '购买邀请码', '当<a href="' . 'config/regist/run'. '" class="J_linkframe_trigger">【注册登录设置】</a>开启邀请注册后设置生效'),
	'invite_buy_credit_num' => array('input', 'basic', '消耗积分', '0或留空为免费，消耗积分类型，请前往<a href="' . 'config/regist/run'. '" class="J_linkframe_trigger">【注册登录设置】</a>中设置', ''),
