...
use App\Services\usergroup\bm\PwUserGroupDm;
use App\Services\usergroup\ds\dao\PwUserGroupsDao;
use App\Core\Hook\PwSimpleHook;
...
class PwUserGroups
{
    ...
    public function addGroup($dm)
    {
        ...
        SimpleHook::getInstance('PwUserGroups_update')->runDo(array($gid));
        return $gid;
    }
    ...
    public function updateGroups($groups)
    {
        ...
        SimpleHook::getInstance('PwUserGroups_update')->runDo($gids);
        return true;
    }
    ...
    {
        return app(PwUserGroupsDao::class);
    }
}