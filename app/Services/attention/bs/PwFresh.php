...
use App\Core\Tool;
use App\Services\attention\ds\dao\PwFreshDao;
use App\Services\attention\ds\dao\PwFreshRelationDao;
...
class PwFresh
{
    ...
    {
        return app(PwFreshDao::class);
    }

    protected function _getRelationDao()
    {
        return app(PwFreshRelationDao::class);
    }
}