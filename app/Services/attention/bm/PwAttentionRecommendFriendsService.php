...
use App\Services\attention\bs\PwAttentionRecommendFriends;
use App\Services\attention\bs\PwAttentionRecommendRecord;
use App\Services\online\bm\PwOnlineCountService;
...
class PwAttentionRecommendFriendsService
{
    ...
    {
        return app(PwAttentionRecommendRecord::class);
    }
    ...
    {
        return app(PwAttentionRecommendFriends::class);
    }
    ...
    {
        return app(PwOnlineCountService::class);
    }
}