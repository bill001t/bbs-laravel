...
namespace App\Services\weibo\bs;

use App\Core\ErrorBag;
use App\Services\weibo\dm\PwWeiboDm;
use App\Services\weibo\ds\dao\PwWeiboDao;
use App\Services\weibo\ds\dao\PwWeiboCommentDao;
...
class PwWeibo {
	...
	protected function _getDao() {
		return app(PwWeiboDao::class);
	}

	protected function _getCommentDao() {
		return app(PwWeiboCommentDao::class);
	}
}