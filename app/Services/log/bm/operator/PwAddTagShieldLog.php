...
use App\Services\log\bm\datasource\PwShieldTagDoReply;
use App\Services\log\bm\datasource\PwShieldTagDoTopic;
use App\Services\log\bm\datasource\PwShieldTagDoWeibo;
 ...
 */
class PwAddTagShieldLog extends BaseHookService
{
    public $typeId;
    public $tagId;
    public $paramId;
    ...
    {
        return app(PwTag::class)->getTag($this->tagId);
    }
