...
namespace App\Services\attach\bs;

use App\Services\attach\dm\PwThreadAttachDm;
use App\Services\attach\ds\dao\PwThreadAttachDao;
...
class PwThreadAttach
{
    ...
    public function addAttach(PwThreadAttachDm $dm)
    {
        ...
        if (($result = $this->_getAttach()->addAttach($dm)) instanceof ErrorBag) {
            return $result;
        }
        $dm->setAid($result);
    ...
    public function updateAttach(PwThreadAttachDm $dm)
    {
        ...
        if (($result = $this->_getAttach()->updateAttach($dm)) instanceof ErrorBag) {
            return $result;
        }
    ...
    public function batchUpdateAttach($aids, PwThreadAttachDm $dm)
    {
        ...
        if (($result = $this->_getAttach()->batchUpdateAttach($aids, $dm)) instanceof ErrorBag) {
            return $result;
        }
    ...
    {
        return app(PwThreadAttachDao::class);
    }
}
