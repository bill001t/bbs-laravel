...
namespace App\Services\report\bs;

use App\Services\report\dm\PwReportDm;
use App\Services\report\ds\dao\PwReportDao;
use Core;
...
class PwReport
{
    ...
    public function updateReport(PwReportDm $dm)
    {
        ...
        return $this->_getDao()->_update($dm->id, $dm->getData());
    }
    ...
    {
        $report = Core::C()->getValues('report');
