...
use App\Services\user\ds\dao\PwUserLoginIpRecodeDao;
...
class PwUserLoginIpRecode {
	...
	public function updateRecode($ip, $lastTime, $error_count) {
		...
		return $this->_getDao()->_update(array('ip' => $ip, 'last_time' => $lastTime, 'error_count' => intval($error_count)));
	}
	...
	private function _getDao() {
		return app(PwUserLoginIpRecodeDao::class);
	}
}