...
use App\Services\user\ds\dao\PwUserMobileVerifyDao;
...
class PwUserMobileVerify {
	 ...
	 * @return bool 
	 */
	public function _delete($mobile) {
		if ($mobile < 1) return false;
		return $this->_getDao()->_delete($mobile);
	}
	...
	public function updateMobile($mobile, PwUserMobileDm $dm) {
		...
		return $this->_getDao()->_update($mobile, $dm->getData());
	}
	...
	protected function _getDao() {
		return app(PwUserMobileVerifyDao::class);
	}
}