...
use App\Services\user\ds\dao\PwUserSearchDao;
/**
 * 搜索用户DS
 *
...
class PwUserSearch {
	...
	public function searchUser(PwUserSo $vo, $limit = 10, $start = 0) {
		return $this->_getDao()->searchUser($vo->getData(), $limit, $vo->getOrderby());
	}
	...
	public function searchUserAllData(PwUserSo $vo, $limit = 10, $start = 0) {
		return $this->_getDao()->searchUserAllData($vo->getData(), $limit, $vo->getOrderby());
	}
	...
	private function _getDao() {
		return app(PwUserSearchDao::class);
	}
}