...
use App\Services\message\ds\dao\PwMessageNoticesDao;
...
class PwMessageNotices
{
     ...
     */
    public function addNotice(PwMessageNoticesDm $dm)
    {
     ...
     * return bool
     */
    public function updateNotice(PwMessageNoticesDm $dm)
    {
    ...
    {
        return app(PwMessageNoticesDao::class);
    }
}