...
class PwNoticeMedal extends PwNoticeAction{
	...
	public function getDetailList($notice){
		...
		$notice['medalInfo'] = app('medal.PwMedalInfo')->getMedalInfo($notice['extend_params']['medelId']);
		$notice['medalInfo']['image'] = app('medal.srv.PwMedalService')->getMedalImage($notice['medalInfo']['path'], $notice['medalInfo']['image']);
