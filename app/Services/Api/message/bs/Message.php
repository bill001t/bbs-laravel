...
namespace App\Services\Api\message\bs;

use App\Services\Api\message\ds\dao\WindidMessageDao;
use App\Services\Api\message\ds\dao\WindidMessageDialogDao;
use App\Services\Api\message\ds\dao\WindidMessageRelationDao;
...
class WindidMessage
{
    ...
    {
        if (!$dm instanceof WindidMessageDm) return new ErrorBag('Message:data_error');
    ...
    {
        return app(WindidMessageDao::class);
    }
    ...
    {
        return app(WindidMessageRelationDao::class);
    }
    ...
    {
        return app(WindidMessageDialogDao::class);
    }
}