...
namespace App\Services\Api\area\bs;

use App\Services\Api\area\ds\dao\AreaDao;
...
class Area {
	 ...
	 * 添加地区
	 *
	 * @param AreaDm $dm 地区的DM
	 * @return boolean
	 */
	public function addArea(AreaDm $dm) {
	...
	public function batchAddArea($dms) {
		...
		foreach ($dms as $_item) {
			if (!$_item instanceof AreaDm) continue;
