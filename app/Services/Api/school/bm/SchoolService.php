...
namespace App\Services\Api\school\bm;

use App\Services\Api\school\bs\School;
...
class SchoolService
{
     ...
     * 查询学校
     *
     * @param SchoolSo $searchSo
     * @param int $limit
     * @param int $start
     * @return array
     */
    public function searchSchool(SchoolSo $searchSo, $limit = 10, $start = 0)
    {
