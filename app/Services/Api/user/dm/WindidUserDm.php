...
namespace App\Services\Api\user\dm;
 ...
 */
class WindidUserDm extends BaseDm
{
    ...
    protected function _beforeAdd()
    {
        ...
        $this->_data['salt'] = Utility::generateRandStr(6);
        $this->_data['password'] = Utility::buildPassword($this->_data['password'], $this->_data['salt']);
