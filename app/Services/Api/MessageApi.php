...
use App\Services\Api\message\bm\WindidBoxMessage;
use App\Services\Api\message\bm\WindidMessageService;
use App\Services\notify\bm\WindidNotifyService;
...
class MessageApi
{
    ...
    {
        return app(WindidBoxMessage::class);
    }
    ...
    {
        return app(WindidNotifyService::class);
    }
}
