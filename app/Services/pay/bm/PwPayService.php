...
//				Wind::import('SRV:pay.srv.paymethod.PwTenpay');
                return new \APP\Services\pay\bm\payment\PwTenpay();
            case 3:
//				Wind::import('SRV:pay.srv.paymethod.PwPaypal');
                return new \APP\Services\pay\bm\payment\PwPaypal();
            case 4:
//				Wind::import('SRV:pay.srv.paymethod.PwBill');
                return new \APP\Services\pay\bm\payment\PwBill();
            default:
//				Wind::import('SRV:pay.srv.paymethod.PwAlipay');
                return new \APP\Services\pay\bm\payment\PwAlipay();
        }
    }
}