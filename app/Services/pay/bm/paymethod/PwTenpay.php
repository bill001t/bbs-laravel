...
class PwTenpay extends PwPayAbstract
{
    ...
    public function __construct()
    {
        ...
        $this->baseurl = 'bbs/tenpay/run';
    }

    public function check()
    {
        if (!$this->tenpay || !$this->tenpay_key) {
            return new ErrorBag('onlinepay.settings.tenpay.error');
        }
        return true;
    }
    ...
    {
        return $this->tenpay . Tool::time2str(Tool::getTime(), 'YmdHis') . str_pad(mt_rand(1, 9999), 4, "0", STR_PAD_LEFT);
    }
    ...
    public function getUrl(PwPayVo $vo)
    {
        ...
        $param = array(
            ...
            'desc' => Tool::convert($vo->getTitle(), 'gbk')
        );
