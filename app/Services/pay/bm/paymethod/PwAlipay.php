...
class PwAlipay extends PwPayAbstract
{
    ...
    public function check()
    {
        if (!$this->alipay || !$this->alipay_partnerID || !$this->alipay_key) {
            return new ErrorBag('onlinepay.settings.alipay.error');
        }
        return true;
    }
    ...
    {
        return '1' . str_pad(Core::getLoginUser()->uid, 10, "0", STR_PAD_LEFT) . Tool::time2str(Tool::getTime(), 'YmdHis') . Utility::generateRandStr(5);
    }
