...
<div class="wrap">
    ...
    <div class="main_wrap">
        <div class="box_wrap register cc">
            <h2 class="reg_head">欢迎注册成为 {{ Core::C('site','info.name')}} 会员</h2>
                        ...
                        <div class="reg_form">
                            ...
                            @if ($config['type'] == 2)
                                <dl>
                                    ...
                                    <dd><span class="must_red">*</span><input id="J_reg_invitecode" name='invitecode'
                                                                              type="text" aria-required="true"
                                                                              class="input length_4"
                                                                              value="{{ $invitecode  or ''
}}"><br/>

                                        @if ($config['invite.pay.open'])
                                            <a href="index.php?m=my&c=invite">购买邀请码</a>
                                        @endif
                                ...
                                <div class="invite_box_wrap" style="display:none">
                                    <div class="invite_box">
                                        <div class="hd"><a href="" class="fr">收起&uarr;</a><strong
                                                    class="b">购买邀请码</strong></div>
                                        <div class="tips">在线支付成功后将自动返回至注册页面并显示邀请码。<br>如果返回后没有显示邀请码，请到电子邮箱查收或联系站长。</div>
                                        <div class="ct">
                                            <ul>
                                                <li><em>电子邮箱：</em><span><input type="email" class="input"></span><span
                                                            class="tips_icon_error">电子邮箱格式错误</span></li>
                                                <li><em>支付金额：</em><span class="s2 mr10">1元</span>有效期1天</li>
                                                <li><em>&nbsp;</em>
                                                    <button type="button" class="btn btn_submit">立即付款</button>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                            ...
                            <dl>
                                ...
                                <dd><span class="must_red">*</span><input aria-required="true" id="J_reg_username"
                                                                          ...
                                                                          type="text"
                                                                          class="input length_4 J_reg_input"
                                                                          value="{{ old('username') }}"></dd>
                            ...
                            @if ($config['active.phone'])
                                <dl id="J_moblie_dl">
                                    ...
                                    <dd><span class="must_red">*</span><input type="hidden" id="J_reg_mobile_hide"
                                                                              name="mobile"><input id="J_reg_mobile"
                                                                                                   data-counttime="90"
                                                                                                   type="text"
                                                                                                   aria-required="true"
                                                                                                   class="input length_4"
                                                                                                   value=""></dd>
                                    <dd class="dd_r">
                                        <button style="display:none;" id="J_show_mcode" name="mobile" type="button"
                                                class="btn mr5">获取验证码
                                        </button>
                                            <span class="dd_r" id="J_reg_tip__mobile" role="tooltip"
                                                  aria-hidden="true"></span><span id="J_mcode_tip" class="reg_tips"
                                                                                  style="display:none;">验证码已发送到<span
                                                    id="J_send_mobile"></span><a href="" id="J_mobile_change"
                                                                                 class="s4">（修改号码）</a>超过90秒未收到验证码，请点击重新发送。<button
                                                    id="J_mcode_resend" class="btn disabled" type="button" disabled>
                                                90秒后重新发送
                                            </button></span></dd>
                                </dl>
                                <dl id="J_mcode_dl">
                                    <dt><label for="">手机验证码：</label></dt>
                                    <dd><span class="must_red">*</span><input id="J_reg_mobileCode"
                                                                              name="mobileCode" type="text"
                                                                              class="input length_4" value=""></dd>
                                    <dd class="dd_r"><span class="dd_r" id="J_reg_tip_mobileCode" role="tooltip"
                            ...
                            @if ($config['active.check'])
                                <dl class="cc">
                                    ...
                                    <dd><span class="must_red">*</span><textarea id="J_reg_regreason"
                                                                                 data-id="regreason"
                                                                                 name="regreason"
                                                                                 class="length_4"></textarea>
                                    </dd>
                            ...
                            @if ($verify)
                                ...
                                <dl class="cc dl_cd">
                                    ...
                                    <dd>
                                        ...
                                        <div class="cc mb5" style="height:30px;"><input id="J_reg_code"
                                                                                        data-id="code"
                                                                                        name="code"
                                                                                        type="text"
                                                                                        class="input length_4 fl">
                                        </div>
                                        <div id="J_register_verify"></div>
                                    </dd>
                                    <dd class="dd_r">
                                        <div id="J_reg_tip_code"></div>
                                    </dd>
                                </dl>
                            @endif
                            <dl>
                                <dt>&nbsp;</dt>
                                <dd>
                                    <button class="btn btn_big btn_submit mr20" type="submit">
                                        同意以下协议并注册
                                    </button>
                                </dd>
                            </dl>
                            <div class="agreements">
                                <div><a id="J_agreements_btn" href="" class="s4" title="点击显示本协议">《本站协议规章内容》</a>
                                </div>
                                                    <pre id="J_agreements_content"
                                                         style="display:none;">{!! $config['protocol'] !!}</pre>
                            </div>
                        </div>
                    </form>
                </div>
            ...
            <div class="reg_side">
                <div class="reg_side_cont">
                    ...
                    <p><a rel="nofollow"
                          href="{{ url('u/login/run?') }} . {{ isset($backurl) ? 'backurl=' . $backurl : '' }}
                          <?php
                          if (isset($invite)) {
                              echo '&invite={$invite}';
                          }
