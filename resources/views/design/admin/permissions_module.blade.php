...
<div class="wrap J_check_wrap">	
	...
	<div class="nav">
		<div class="return"><a href="{{ url('design/module/run') }}">返回上一级</a></div>
		<ul class="cc">
			<li class="current"><a href="{{ url('design/permissions/module?id=' . $designId) }}">模块权限管理</a></li>
		</ul>
	</div>
	<div class="h_a">功能说明</div>
	<div class="prompt_text">
		<ol>
			<li>编辑模块：对此模块有编辑权限； </li>
			<li>管理内容：推送的内容可以直接显示，拥有模块显示内容、推送内容和添加内容的管理权限； </li>
			<li>推送内容需审核：可推送内容到此模块，但需要通过审核后才会显示。</li>
		</ol>
	</div>
...
@foreach ($list as $v)
			...
			<tr>
				...
				<td><a href="{{ url('design/permissions/delete') }}" class="J_ajax_del" data-pdata="{'id': {{ $v['id'] }}}">[删除]</a></td>
			</tr>
			<!--# } #-->
			<tr>
				<td><input data-xid="J_check_x" data-yid="J_check_y" class="J_check" type="checkbox" name="del_ids[]" value=""></td>
		...
		<!-- <div class="p10"><a href="" class="link_add" id="J_add_root" data-html="tbody">添加用户</a></div> -->
	</div>
	<div class="btn_wrap">
		<div class="btn_wrap_pd">
			...
			<button class="btn J_ajax_submit_btn" data-subcheck="true" data-msg="确定删除选中的项？" data-action="{{ url('design/permissions/batchdelete') }}" type="submit">删除</button>
