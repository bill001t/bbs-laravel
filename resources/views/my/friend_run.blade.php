...
{{-- @include('common.header') --}}
	<div class="main_wrap">
		<div class="bread_crumb">
			...
			<a href="{{ url('my/friend/run') }}">推荐关注</a>
		</div>
		<div class="main cc">
			<div class="main_body">
				<div class="main_content cc">
					<div class="box_wrap fans_page">
						...
						<div class="content_type">
							<ul class="cc">
								<li class="current"><a href="{{ url('my/friend/run') }}">推荐关注</a></li>
...
$birthday = $value['byear'] ? '生日：' . $value['byear'] . '年'.$value['bmonth'].'月'.$value['bday'].'日' : '';
							...
							<dl class="cc J_friends_items">
								...
								<dd>
									...
									<div class="attribute">
										<a href="{{ url('my/follow/add') }}" class="core_follow J_fans_follow" data-uid="{{ $value['uid'] }}" data-role="follow">加关注</a>
									</div>
								</dd>
							</dl>
							<!--# } #-->
...
@else
						...
						<div class="nofollow_list"><div class="hd">啊哦，暂时还没有推荐的人哦！</div></div>
						<!--# } #-->
					</div>
				</div>
			</div>
