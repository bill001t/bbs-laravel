...
#-->
			<tr>
				<td><div class="app_icon"><b></b><img src="{{ $app['logo'] }}" onerror="this.onerror=null;this.src={{ asset('assets/images') }}/admin/yy.png'" alt="{{ $app['name'] }}" width="80" height="80"></div></td>
				<td valign="top">
...
$app_ids[] = $app['app_id']; } #-->
				...
				<td><span>{{ App\Core\Tool::time2str($app['created_time']) }}</span></td>
				<td>
...
@if($app['status'] & 4 && app('APPCENTER:service.srv.PwDebugApplication')->inDevMode1())
