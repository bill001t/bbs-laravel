...
@if(empty($storages))
						...
						#-->
						<li><span class="mr20"><label><input name="att_storage" data-msg="{{ $value['description'] }}" value="{{ $var }}" type="radio" {{ App\Core\Tool::ifcheck($storageType==$var) }}><span>{{ $value['name'] }}</span></label></span>
...
@if (empty($windidStorages))
						...
						#-->
						<li><span class="mr20"><label><input name="avatar_storage" data-msg="{{ $value['description'] }}" value="{{ $var }}" type="radio" {{ App\Core\Tool::ifcheck($windidStorageType==$var) }}><span>{{ $value['name'] }}</span></label></span>
