...
<!--弹窗详情-->
	...
	<div class="notice_segment_wrap">
		<dl class="notice_segment_list cc">
			...
			<dd class="notice_segment_cont">
				<div class="summary"> {{ $notice['title'] }}

@if ($notice['extend_params']['ban'] == 1)
$endTime = $notice['extend_params']['end_time'] ? App\Core\Tool::time2str($notice['extend_params']['end_time'], 'Y-m-d H:i:s') : '永久禁止';
					#-->
					<div>
						到期时间：{$endTime}<br/>
...
@if ($v['extend_params']['ban'] == 1)
$endTime = $v['extend_params']['end_time'] ? App\Core\Tool::time2str($v['extend_params']['end_time'], 'Y-m-d H:i:s') : '永久禁止';
					#-->
