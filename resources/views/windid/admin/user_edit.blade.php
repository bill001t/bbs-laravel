...
<div class="table_full">
	<table width="100%">
		...
		<tr>
			<th>头像</th>
			<td><div><img id="J_face_img" class="J_avatar" data-type="middle" src="{{ App\Core\Tool::getAvatar($info['uid']) }}?t={{ App\Core\Tool::getTime() }}" class="face"></div><a id="J_set_def" href="{{ url('windid/user/defaultAvatar?uid=' . $info['uid']) }}">[恢复为系统头像]</a></td>
		</tr>
		<tr>
			<th>新密码</th>
