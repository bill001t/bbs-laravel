...
@foreach ($replies as $key => $value)
	...
	<dl class="cc">
		<dt><a class="J_user_card_show" data-uid="{{ $value['created_userid'] }}" href="{{ url('space/index/run?uid=' . $value['created_userid']) }}"><img class="J_avatar" data-type="small" src="{{ App\Core\Tool::getAvatar($value['created_userid']) }}" width="30" height="30" /></a></dt>
		<dd>
