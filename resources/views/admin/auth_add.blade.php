...
<!--用户权限编辑添加: 添加用户-->
<form id="J_auth_form" action="{{ url('auth/doAdd') }}" method="post">
<div>
	<div class="pop_cont">
		<div class="mb15"><h4 class="mb5">用户名</h4><input name="username" type="text" class="input input_hd" style="width:396px;"></div>
		<div class="cc shift">
			<div class="fl">
				<h4>选择角色</h4>
