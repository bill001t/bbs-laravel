...
@if($v['category_id']==$categoryId)
 selected<!--# } #-->>{{ $v['category_name'] }}</option>
							<!--# } #-->
						</select>
					</li>
					<li>
...
$relatedTopics = $v['joinTag'];
				...
				<tr>
					...
					<td><img src="{{ App\Core\Tool::getPath($v['tag_logo']) }}" width="50" height="50" class="fl" onerror="this.onerror=null;this.src='<?php echo Core::url()->themes; ?>/site/default/images/tags/default.png'" /></td>
					<td>
