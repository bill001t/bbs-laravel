...
{{-- @include('common.header') --}}
	<div class="main_wrap">
		...
		<div class="bread_crumb">
			<a href="{{ url() }}" class="home" title="{{ Core::C('site', 'info.name') }}">首页</a><em>&gt;</em><a href="{{ url('tag/index/run') }}">话题</a><em>&gt;</em><a href="{{ url('tag/index/run') }}">热门话题</a>
		</div>
		<div class="tag_page_run cc">
			<div class="tag_nav">
				<ul class="cc">
					<li class="current"><a href="{{ url('tag/index/run') }}">热门话题</a></li>
					<li><a rel="nofollow" href="{{ url('tag/index/my') }}" data-referer="true" class="J_qlogin_trigger">我关注的话题</a></li>
				</ul>
			</div>
			<!--新话题列表-->
			<div class="mb20">
...
@foreach ($v['attentions'] as $uv)
							...
							<a class="J_user_card_show" data-uid="{{ $uv }}" href="{{ url('space/index/run?uid=' . $uv) }}"><img class="J_avatar" src="{{ App\Core\Tool::getAvatar($uv, 'small') }}" data-type="small" width="40" height="40" alt="" /></a>
						<!--# } #-->
						</dd>
					</dl>
				<!--# } #-->
